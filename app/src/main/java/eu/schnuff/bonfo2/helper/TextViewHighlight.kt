...
fun TextView.setHighlightedText(text: String?, highlighting: Collection<Regex>, HIGHLIGHT_COLORS: Array<Int>, formattedBy: Int? = null) {
...
fun TextView.setHighlightedText(texts: Array<String>, highlighting: Collection<Regex>, HIGHLIGHT_COLORS: Array<Int>, formattedBy: Int? = null) {
    if (texts.isEmpty()) {
        this.visibility = View.GONE
    } else {
        this.visibility = View.VISIBLE
...
private fun highlight(item: String?, highlighting: Collection<Regex>, HIGHLIGHT_COLORS: Array<Int>) : String {
    return when {
        item === null -> ""
        highlighting.isNotEmpty() -> {
            highlighting.foldIndexed(item) { myI, acc, highlight ->
                val i = myI % HIGHLIGHT_COLORS.size
                acc.replace(highlight) {
                    HIGHLIGHT.format(HIGHLIGHT_COLORS[i], it.value)
                }
            }
        }
        else -> item
...
private fun highlight(items: Array<String>, highlighting: Collection<Regex>, HIGHLIGHT_COLORS: Array<Int>) : String =
